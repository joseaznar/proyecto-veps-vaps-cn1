...
%Esta función calcula el eigenvalor(sigmai) y el eigenvector (qi) de la matriz A dependiendo de q0.
...
while i <= k && e > tol 
   ...
   temp = B\qi;               %se calcula la aproximación del eigenvector de la inversa.
